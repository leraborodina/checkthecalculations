...
class MainActivity : AppCompatActivity() {
    ...
    fun onClickStartBtn(view: View)
    {
        ...
        var oneOperator = (10..99).random()
        var twoOperator = (10..99).random()
        if (operand == "/")
        {
            while (oneOperator%twoOperator!=0)
            {
                oneOperator = (10..99).random()
        ...
        if (chance == 1)
        {
            choice = true
            when (operand){
                "+" -> result = oneOperator+twoOperator
                "-" -> result = oneOperator-twoOperator
                "*" -> result = oneOperator*twoOperator
                "/" -> result = oneOperator/twoOperator
            }
        ...
        binding.FirstOperandTxt.text = oneOperator.toString()
